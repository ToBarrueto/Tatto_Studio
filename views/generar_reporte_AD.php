...
function generarInformePDF($año)
{
    ...
    $pdf->SetTitle('Informe de Tatuajes');
    ...
    // Encabezado
    $html = '<h1 style="text-align:center;">Informe de Anual de Desempeño - Año ' . $año . '</h1>';
    ...
    // Salida del PDF
    $pdf->Output('Informe_tatuajes_' . $año . '.pdf', 'I');
}
