...
<body class="fondo">
  ...
  <div id="textCarousel" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <div class="carousel-text">
          ...
          <p>Nuestros artistas son más que simplemente tatuadores; son expertos en transformar ideas en obras de arte duraderas en la piel.</p>
      ...
      <div class="carousel-item">
        <div class="carousel-text">
          <h5>Perforistas</h5>
          <p>Nuestros perforistas de piercings son expertos en su oficio, utilizando técnicas precisas y herramientas de la más alta calidad para garantizar perforaciones limpias y seguras.</p>
    ...
    <!-- Agregar enlaces a los scripts de Bootstrap y otros scripts -->
</body>
